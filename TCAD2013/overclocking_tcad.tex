...
\begin{table*}[htbp]
 ...
 %% increase table row spacing, adjust to taste
   ...
   \setlength{\tabcolsep}{3.5pt}
   %\caption{Relative Reduction of MRE in Overclocking Scenario for Various Normalized Frequencies Based on~(\ref{Relative Reduction MRE}).}
   \caption{Area Overhead of Out Approach with respect to Given Frequency Requirements}
%   \vspace{-2ex}
   \centering
   \footnotesize
   %\vspace{-4mm}
...
%   \vspace{-2ex}
   ...
   \begin{tabular}{c|cc|cc|cc|cc|cc||cc}
     ...
     5    & 1.24&	1.05& 1.00&	1.00& 1.26&   1.42&   1.65&   1.11&	 1.00&    1.00   &1.18    &1.18\\
     10   & 1.24&	1.05& 1.12&	1.22& 1.26&	1.42& 1.65&	1.11& 1.11&	 1.15&    1.18    &1.18\\
     20   & 1.24&	1.05& 1.03&	1.08& 1.26&	1.42& 6.92&	 5.25&   3.45&	 2.17   &2.07    &11.78\\
