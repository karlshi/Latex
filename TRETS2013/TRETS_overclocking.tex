...
\category{B.3.3}{Performance Analysis and Design Aids}{Detail category}
...
While this research has shown a promising direction for sustaining performance scaling, in the future we wish to extend the current model by considering the propagation of error through arithmetic circuits at component level, and to apply this approach beyond datapath designs with a variety of PVT variations.
