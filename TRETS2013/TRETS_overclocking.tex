...
\begin{figure}[ht]
    ...
    \vspace{-1.5ex}
    \caption{(a) The modeled value and experimental results of the maximum word-length of RCA and CSA, with respect to various frequency requirements. (b) Hardware resource usage for an RCA and a CSA with 2 and 3 stages.}
    \vspace{-1ex}
\end{figure}
